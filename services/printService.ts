...
const getCommonStyles = (theme: 'blue' | 'orange' = 'blue') => {
  return `
    ...
    * { box-sizing: border-box; margin: 0; padding: 0;
    ...
    .doc-logo { height: 40px; width: auto; opacity: 0.9; }
    .doc-company { flex: 1; }
    .doc-company-name {
      font-size: 14px; font-weight: 600; color: #1d1d1f; letter-spacing: -0.01em;
    }
    .doc-company-info {
      font-size: 9.5px; color: #86868b; line-height: 1.5; margin-top: 2px;
    }

    /* ═══  DOCUMENT TITLE  ═══ */
    .doc-title-section { margin-bottom: 28px; }
    .doc-title {
    ...
    .doc-meta-item { font-size: 12px; color: #86868b; }
    ...
    .info-card {
      background: #f5f5f7; border-radius: 12px; padding: 16px 20px;
    }
    .info-card-label {
    ...
    .info-card-divider { height: 0.5px; background: #d2d2d7; margin: 10px 0; }
    ...
    .section-count { font-size: 11px; font-weight: 600; color: #86868b; }

    .items-table { width: 100%; border-collapse: collapse; font-size: 11px; }
    .items-table th {
      text-align: left; font-size: 10px; font-weight: 600; color: #86868b;
    ...
    .items-table td {
      padding: 14px 12px; border-bottom: 0.5px solid #e8e8ed;
      vertical-align: top; color: #1d1d1f;
    }
    .items-table td.center { text-align: center; color: #86868b; }
    ...
    .item-serial {
      ...
      font-size: 10px; color: #1d1d1f; background: #f5f5f7;
      padding: 2px 8px; border-radius: 4px; margin-top: 6px;
    }
    .item-serial-new {
      display: inline-block; font-family: 'Inter', 'SF Mono', monospace;
      font-size: 10px; color: #248a3d; background: #f0faf0;
    ...
    /* ═══  REMARKS  ═══ */
    .remarks { margin-bottom: 40px; font-size: 10px; color: #6e6e73; line-height: 1.7; }
    .remarks-title {
    ...
    .signatures {
      display: grid; grid-template-columns: 1fr 1fr;
      gap: 32px; margin-top: auto; page-break-inside: avoid;
    }
    .sig-label {
      font-size: 10px; font-weight: 600; color: #86868b;
      text-transform: uppercase; letter-spacing: 0.04em; margin-bottom: 40px;
    }
    ...
    return `
      <tr>
        ...
        <td>
          ...
          ${item.deviceUsername ? `<div class="item-detail" style="color:#bf5f00;">User: ${item.deviceUsername} / Pass: ${item.devicePassword}</div>` : ''}
    ...
    <div class="print-doc">
      ...
      <div class="doc-title-section">
        ...
        <div class="doc-meta">
          ...
          <div class="doc-meta-item">จำนวน: <strong>${rmas.length} รายการ</strong></div>
        </div>
      </div>

      <div class="info-cards">
        <div class="info-card">
          <div class="info-card-label">เรียน ผู้นำเข้า / Distributor</div>
